...
function StatusIcons({ theme }: { theme: "light" | "dark" }) {
...
export function DeviceChromeOverlay({ chrome, width, theme = "dark", presetId }: DeviceChromeOverlayProps) {
  ...
  const bottomBarColor = theme === "light" ? "bg-black/80" : "bg-white/90";
  ...
  return (
    <>
      ...
      {chrome.bottom > 0 && (
        ...
        >
          <div
            className={`rounded-full ${bottomBarColor}`}
