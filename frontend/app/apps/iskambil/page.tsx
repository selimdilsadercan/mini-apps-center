              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    ...
                    <div className="bg-[#ffffff] border border-[#e2dec5] rounded-3xl p-6 min-h-[400px] max-h-[580px] overflow-y-auto space-y-6 font-sans text-base text-slate-700 leading-relaxed shadow-sm scrollbar-thin scrollbar-thumb-[#e2dec5]">
                      {/* Check if we have the new detailed layout */}
                      {(lang === "tr" ? selectedGame.quick_rules_tr : selectedGame.quick_rules_en) ? (
                        <div className="space-y-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <ol className="space-y-2 list-decimal list-inside pl-1">
                              {(lang === "tr" ? selectedGame.quick_rules_tr : selectedGame.quick_rules_en)?.map((rule, idx) => (
                          ...
                          {/* Setup */}
                          {(lang === "tr" ? selectedGame.setup_tr : selectedGame.setup_en) && (
                            <div className="space-y-2">
                              <h4 className="text-xs font-black uppercase text-[#0c3122] tracking-wider border-b border-[#f4f1ea] pb-1">
                                {lang === "tr" ? "Kurulum" : "Setup"}
                              </h4>
                              <ol className="space-y-2 list-decimal list-inside pl-1">
                                {(lang === "tr" ? selectedGame.setup_tr : selectedGame.setup_en)?.map((step, idx) => (
                                  <li key={idx} className="marker:text-[#0c3122] marker:font-black pb-1 last:pb-0">
                          ...
                          {/* Objective */}
                          {(lang === "tr" ? selectedGame.objective_tr : selectedGame.objective_en) && (
                            <div className="space-y-2">
                              <h4 className="text-xs font-black uppercase text-[#0c3122] tracking-wider border-b border-[#f4f1ea] pb-1">
                          ...
                          {/* Gameplay */}
                          {(lang === "tr" ? selectedGame.gameplay_tr : selectedGame.gameplay_en) && (
                            <div className="space-y-2">
                              <h4 className="text-xs font-black uppercase text-[#0c3122] tracking-wider border-b border-[#f4f1ea] pb-1">
                                {lang === "tr" ? "Oynanış" : "Gameplay"}
                              </h4>
                              <ol className="space-y-2 list-decimal list-inside pl-1">
                                {(lang === "tr" ? selectedGame.gameplay_tr : selectedGame.gameplay_en)?.map((step, idx) => (
                                  <li key={idx} className="marker:text-[#0c3122] marker:font-black pb-1 last:pb-0">
                                    <span className="inline-block md:inline text-slate-700 text-sm leading-relaxed">{step}</span>
                                  </li>
                                ))}
                          ...
                          {/* Scoring */}
                          {(lang === "tr" ? selectedGame.scoring_tr : selectedGame.scoring_en) && (
                            <div className="space-y-2">
                              <h4 className="text-xs font-black uppercase text-[#0c3122] tracking-wider border-b border-[#f4f1ea] pb-1">
                                {lang === "tr" ? "Puanlama" : "Scoring"}
                              </h4>
                              <ol className="space-y-2 list-decimal list-inside pl-1">
                                {(lang === "tr" ? selectedGame.scoring_tr : selectedGame.scoring_en)?.map((rule, idx) => (
                                  <li key={idx} className="marker:text-[#0c3122] marker:font-black pb-1 last:pb-0">
                                    <span className="inline-block md:inline text-slate-700 text-sm leading-relaxed">{rule}</span>
                                  </li>
                                ))}
                          ...
                          {/* Ending */}
                          {(lang === "tr" ? selectedGame.ending_tr : selectedGame.ending_en) && (
                            <div className="space-y-2">
                              <h4 className="text-xs font-black uppercase text-[#0c3122] tracking-wider border-b border-[#f4f1ea] pb-1">
                                {lang === "tr" ? "Oyun Sonu" : "Ending"}
                              </h4>
                              <ol className="space-y-2 list-decimal list-inside pl-1">
                                {(lang === "tr" ? selectedGame.ending_tr : selectedGame.ending_en)?.map((rule, idx) => (
                                  <li key={idx} className="marker:text-[#0c3122] marker:font-black pb-1 last:pb-0">
                                    <span className="inline-block md:inline text-slate-700 text-sm leading-relaxed">{rule}</span>
                                  </li>
                                ))}
                          ...
                          {/* Notes */}
                          {(lang === "tr" ? selectedGame.notes_tr : selectedGame.notes_en) && (
                            <div className="space-y-2">
                              <h4 className="text-xs font-black uppercase text-[#0c3122] tracking-wider border-b border-[#f4f1ea] pb-1">
                                {lang === "tr" ? "Özel Notlar" : "Notes"}
                              </h4>
                              <ol className="space-y-2 list-decimal list-inside pl-1">
                                {(lang === "tr" ? selectedGame.notes_tr : selectedGame.notes_en)?.map((note, idx) => (
                                  <li key={idx} className="marker:text-[#0c3122] marker:font-black pb-1 last:pb-0">
