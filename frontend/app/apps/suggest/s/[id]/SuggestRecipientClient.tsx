...
interface SuggestRecipientClientProps {
  id: string;
  initialSuggestion: suggest.Suggestion;
  initialSenderName: string | null;
  initialSenderAvatar: string | null;
  initialSenderClerkId: string | null;
...
export default function SuggestRecipientClient({
  ...
  const [senderAvatar, setSenderAvatar] = useState<string | null>(initialSenderAvatar);
  const [senderClerkId, setSenderClerkId] = useState<string | null>(initialSenderClerkId);
  const [selectedReaction, setSelectedReaction] = useState<string | null>(initialSuggestion?.reaction || null);
