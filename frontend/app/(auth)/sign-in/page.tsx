    ...
    <div className="flex min-h-screen items-center justify-center bg-[#FAF9F7] p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 px-4 hover:bg-gray-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {isLoading ? (
          ...
          <span className="font-medium text-gray-700">{isLoading ? "Bağlanıyor..." : "Google ile devam et"}</span>
        </button>
      </div>
    </div>
  );
