...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-app-bg p-6 text-app-text">
      <div className="w-full max-w-md bg-app-surface border border-app-border rounded-2xl shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-app-text mb-2">{t.welcome}</h1>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-app-border rounded-xl py-3 px-4 hover:bg-app-surface-muted transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            {pendingProvider === "google" ? (
              ...
              <>
                ...
                <span className="font-medium text-app-text">{t.continueWithGoogle}</span>
              </>
            )}
          </button>
          ...
          >
            {pendingProvider === "apple" ? (
              ...
              <>
                <svg className="w-5 h-5 text-current shrink-0" viewBox="0 0 384 512" fill="currentColor">
                ...
                <span className="font-medium text-app-text">{t.continueWithApple}</span>
              </>
            )}
          </button>
        </div>

        <p className="mt-6 text-xs text-app-muted text-center leading-relaxed">
          {t.termsStart}{" "}
