  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h3 className="font-bold text-gray-900 text-[14px] tracking-tight truncate group-hover:text-indigo-600 transition-colors">
          {title}
        </h3>
        <p className="text-gray-400 text-[11px] font-medium truncate leading-tight">
          {subtitle}
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-gray-900 text-[14px] tracking-tight truncate group-hover:text-indigo-600 transition-colors mb-0.5">
            {appName}
          </h3>
          <p className="text-gray-400 text-[11px] font-medium line-clamp-1 leading-tight">
            {app.description}
          </p>
        </div>
