...
/**
 * Sürdürülebiliriz — tanıtım sayfası.
 * Bu dosyayı özgürce düzenleyin; her uygulamanın tasarımı ayrıdır.
 */
export default function SurdurulebilirlikDirectoryPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 pb-8 space-y-10">
      <section className="space-y-4">
        <div className="flex items-start gap-4">
          <DirectoryAppIcon appId="surdurulebilirlik" />
        ...
        <p className="text-lg text-zinc-400 font-medium leading-relaxed max-w-2xl">
          Doğa dostu adımlarını takip et, dünyamıza katkıda bulun.
        </p>
      </section>

      <div className="prose prose-invert max-w-none">
        <p className="text-zinc-400 leading-relaxed mb-4">Everything super app içindeki Sürdürülebiliriz uygulaması ile doğa dostu adımlarını takip et, dünyamıza katkıda bulun.</p>
