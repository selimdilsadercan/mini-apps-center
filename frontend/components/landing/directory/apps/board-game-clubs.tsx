    ...
    <div className="max-w-5xl mx-auto px-6 pb-8 space-y-10">
      <section className="space-y-4">
        ...
        <p className="text-lg text-zinc-400 font-medium leading-relaxed max-w-2xl">
          Oyun kütüphanenizi yönetin ve kulüp üyeleriyle etkileşime geçin.
        </p>
      </section>

      <div className="prose prose-invert max-w-none">
        <p className="text-zinc-400 leading-relaxed mb-4">Everything super app içindeki Board Game Clubs uygulaması ile oyun kütüphanenizi yönetin ve kulüp üyeleriyle etkileşime geçin.</p>
