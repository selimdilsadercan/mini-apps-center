...
export namespace eksik_var {
    export interface AcceptShareInviteRequest {
        inviteId: string
        userId: string
    }
    ...
    export interface CreateShareInviteRequest {
        userId: string
    }

    export interface CreateShareInviteResponse {
        inviteId: string
    }
    ...
    export interface GetSharedMembersResponse {
    ...
    export interface RemoveSharedMemberResponse {
        success: boolean
    }

    export interface ShareWithFriendRequest {
        userId: string
        friendUserId: string
    }

    export interface ShareWithFriendResponse {
        success: boolean
    }
    ...
    export interface ToggleItemUsedRequest {
        userId: string
    }

    export interface ToggleItemUsedResponse {
        item: MissingItem | null
    }
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.acceptShareInvite = this.acceptShareInvite.bind(this)
            this.addItem = this.addItem.bind(this)
            this.createShareInvite = this.createShareInvite.bind(this)
            this.deleteItem = this.deleteItem.bind(this)
            this.getInviteDetails = this.getInviteDetails.bind(this)
            this.getItems = this.getItems.bind(this)
            this.getSharedMembers = this.getSharedMembers.bind(this)
         ...
         */
        public async acceptShareInvite(params: AcceptShareInviteRequest): Promise<AcceptShareInviteResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/eksik-var/share/invite/accept`, JSON.stringify(params))
            return await resp.json() as AcceptShareInviteResponse
        }
         ...
         */
        public async createShareInvite(params: CreateShareInviteRequest): Promise<CreateShareInviteResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/eksik-var/share/invite/create`, JSON.stringify(params))
            return await resp.json() as CreateShareInviteResponse
        }
         ...
         */
        public async getInviteDetails(inviteId: string): Promise<InviteDetails> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/eksik-var/share/invite/${encodeURIComponent(inviteId)}`)
            return await resp.json() as InviteDetails
        }
         ...
         */
        public async getSharedMembers(userId: string): Promise<GetSharedMembersResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/eksik-var/share/members/${encodeURIComponent(userId)}`)
            return await resp.json() as GetSharedMembersResponse
        }
         ...
         */
        public async removeSharedMember(params: RemoveSharedMemberRequest): Promise<RemoveSharedMemberResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/eksik-var/share/remove`, JSON.stringify(params))
            return await resp.json() as RemoveSharedMemberResponse
        }
         ...
         */
        public async shareWithFriend(params: ShareWithFriendRequest): Promise<ShareWithFriendResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/eksik-var/share/friend`, JSON.stringify(params))
            return await resp.json() as ShareWithFriendResponse
        }
         ...
         */
        public async toggleItemUsed(id: string, params: ToggleItemUsedRequest): Promise<ToggleItemUsedResponse> {
            // Now make the actual call to the API
