...
const RAW_MINI_APPS: MiniApp[] = [
  ...
  },
  {
    id: "workplaces",
    name: "Mekanlar",
    description: "Kahramanmaraş'taki kafeler, restoranlar ve çalışma mekanlarını keşfet.",
    cta: "Mekanları Keşfet",
    icon: Coffee,
    category: "Şehrini Keşfet",
    color: "#6F4E37",
  ...
  {
    id: "places-ranked",
    name: "Mekan Sıralaması",
    description: "Şehrindeki mekanları topluluk oylarıyla sırala — IMDb tarzı 1–10 puanlama.",
    cta: "Sıralamaları Gör",
    icon: Trophy,
    category: "Şehrini Keşfet",
    color: "#7C3AED",
    ...
    isImplemented: true,
    subdomain: "ranked",
    statusBarColor: "#FAFAFC",
    statusBarStyle: "light",
    navigationBarColor: "#FAFAFC",
    navigationBarStyle: "light",
  },
  {
    id: "digital-menu",
  ...
  },
  {
    ...
    cta: "Spor Maçlarını Takip Et",
    icon: Trophy,
    category: "Eğlence & Hobi",
    color: "#059669",
    href: "/apps/buyuk-maclar",
    isImplemented: true,
    subdomain: "buyukmaclar",
    statusBarColor: "#FAF9F7",
    statusBarStyle: "light",
    navigationBarColor: "#FAF9F7",
    navigationBarStyle: "light",
  ...
  {
    id: "yks-tercih",
    name: "YKS Taban Puanları",
    description: "YKS üniversite taban puanları, başarı sıralamaları ve tercih robotu.",
    cta: "Tercih Yap",
    icon: GraduationCap,
    category: "Kampüslülere Özel",
    color: "#2563EB",
  ...
  {
    id: "tus-kitap",
    name: "TUS Kitap Takibi",
    description: "Infotus TUS konu kitapları çalışma takibi ve bölüm tekrar sayacı.",
    cta: "Çalışmaya Başla",
    icon: BookOpen,
    category: "Kampüslülere Özel",
    color: "#DC2626",
