-- Drop friendship schema and its tables/functions if they exist
DROP TABLE IF EXISTS friendship.friends CASCADE;
DROP SCHEMA IF EXISTS friendship CASCADE;

-- Create friends table in public schema
