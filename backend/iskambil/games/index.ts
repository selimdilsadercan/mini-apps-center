...
import spiteAndMalice from "./patience-strategy/spite-and-malice.json";
...
import ginRummy from "./rummy-meld-building/gin-rummy.json";
import authors from "./matching-capturing/authors.json";
import casino from "./matching-capturing/casino.json";
import dostKazigi from "./matching-capturing/dost-kazigi.json";
import scopa from "./matching-capturing/scopa.json";
import gops from "./matching-capturing/gops.json";
import pisti from "./matching-capturing/pisti.json";
import esliBatak from "./trick-taking-trump/esli-batak.json";
import sixtySix from "./trick-taking-trump/sixty-six.json";
...
import germanWhist from "./trick-taking-trump/german-whist.json";
import ikiliBatak from "./trick-taking-trump/ikili-batak.json";
...
import crazyEights from "./shedding/crazy-eights.json";
