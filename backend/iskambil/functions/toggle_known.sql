...
-- Re-create with logic
CREATE OR REPLACE FUNCTION iskambil.toggle_known(game_id_param TEXT, clerk_id_param TEXT)
RETURNS BOOLEAN AS $$
DECLARE
    exists_val BOOLEAN;
BEGIN
    ...
    IF exists_val THEN
        ...
        RETURN FALSE;
    ELSE
        INSERT INTO iskambil.known_games (game_id, clerk_id)
